...
@Component({
  selector: 'app-posted-tenders',
  templateUrl: './posted-tenders.component.html',
  styleUrls: ['./posted-tenders.component.sass']
})
export class PostedTendersComponent extends BaseComponent implements OnInit {
