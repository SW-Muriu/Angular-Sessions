...
@Component({
  selector: 'app-rejected-tenders',
  templateUrl: './rejected-tenders.component.html',
  styleUrls: ['./rejected-tenders.component.sass']
})
export class RejectedTendersComponent extends BaseComponent implements OnInit {
