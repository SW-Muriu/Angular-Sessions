...
@Component({
  selector: 'app-all-tender-adverts',
  templateUrl: './all-tender-adverts.component.html',
  styleUrls: ['./all-tender-adverts.component.sass']
})
export class AllTenderAdvertsComponent extends BaseComponent implements OnInit {
