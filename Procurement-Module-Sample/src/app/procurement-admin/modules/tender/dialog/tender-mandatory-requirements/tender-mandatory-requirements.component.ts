...
@Component({
  selector: 'app-tender-mandatory-requirements',
  templateUrl: './tender-mandatory-requirements.component.html',
  styleUrls: ['./tender-mandatory-requirements.component.sass']
})
export class TenderMandatoryRequirementsComponent extends BaseComponent implements OnInit {
  ...
  getTenders() {
    this.tenderPreperationRequirements
      .listTenderMandatoryRequirements()
