...
@Component({
  selector: 'app-tender-technical-requirements',
  templateUrl: './tender-technical-requirements.component.html',
  styleUrls: ['./tender-technical-requirements.component.sass']
})
export class TenderTechnicalRequirementsComponent extends BaseComponent implements OnInit {
  ...
  getTenders() {
    this.tenderPreperationRequirements
      .listAllTechnicalTenderRequirements()
