...
@Component({
  selector: 'app-partially-verified',
  templateUrl: './partially-verified.component.html',
  styleUrls: ['./partially-verified.component.sass']
})
export class PartiallyVerifiedComponent implements OnInit {
  ...
  getPartialAnnouncements() {
    this.announcementService.getPartialAnnouncements().subscribe(
      (res) => {
