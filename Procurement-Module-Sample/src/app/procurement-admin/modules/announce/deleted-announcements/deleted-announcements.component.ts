...
@Component({
  selector: 'app-deleted-announcements',
  templateUrl: './deleted-announcements.component.html',
  styleUrls: ['./deleted-announcements.component.sass']
})
export class DeletedAnnouncementsComponent implements OnInit {
