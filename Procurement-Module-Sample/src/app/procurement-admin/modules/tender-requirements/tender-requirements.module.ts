...
import { TenderRequirementsRoutingModule } from './tender-requirements-routing.module';
...
@NgModule({
  declarations: [
    AddTenderRequirementComponent,
    EditTenderRequirementComponent,
    MandatoryRequirementsComponent,
    FinancialRequirementsComponent,
    TechnicalRequirementsComponent
  ],
  imports: [
    CommonModule,
    TenderRequirementsRoutingModule,
...
export class TenderRequirementsModule { }
