...
@Component({
  selector: 'app-unsuccessful-rfq-applications',
  templateUrl: './unsuccessful-rfq-applications.component.html',
  styleUrls: ['./unsuccessful-rfq-applications.component.sass']
})
export class UnsuccessfulRfqApplicationsComponent extends BaseComponent implements OnInit {
