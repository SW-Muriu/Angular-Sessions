...
import { RfqApplicationDetailsComponent } from "src/app/commons/modules/rfqs/pages/dialogs/rfq-application-details/rfq-application-details.component";
...
@Component({
  ...
  styleUrls: ["./rfqs.component.sass"],
})
export class RfqsComponent extends BaseComponent implements OnInit {
