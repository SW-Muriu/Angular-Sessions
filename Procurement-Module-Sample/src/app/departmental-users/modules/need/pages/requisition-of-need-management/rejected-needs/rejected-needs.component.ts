...
@Component({
  selector: 'app-rejected-needs',
  templateUrl: './rejected-needs.component.html',
  styleUrls: ['./rejected-needs.component.sass']
})
export class RejectedNeedsComponent extends BaseComponent implements OnInit {
