...
@Component({
  selector: 'app-rfq-approved-applications',
  templateUrl: './rfq-approved-applications.component.html',
  styleUrls: ['./rfq-approved-applications.component.sass']
})
export class RfqApprovedApplicationsComponent extends BaseComponent implements OnInit {
