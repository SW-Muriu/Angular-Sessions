...
import { FilesService, SelectedFiles } from "src/app/suppliers/data/fileconversion/files.service";

@Component({
  selector: "app-rfq-bid",
  templateUrl: "./rfq-bid.component.html",
  styleUrls: ["./rfq-bid.component.sass"],
})
export class RfqBidComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.rfqDetails) {
      this.bidRfqForm.patchValue({
        ...
        rfqtitle: this.rfqDetails.title,
      });
