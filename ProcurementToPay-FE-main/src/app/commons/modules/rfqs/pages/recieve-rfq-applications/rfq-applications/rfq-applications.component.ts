...
@Component({
  selector: 'app-rfq-applications',
  templateUrl: './rfq-applications.component.html',
  styleUrls: ['./rfq-applications.component.sass']
})
export class RfqApplicationsComponent extends BaseComponent implements OnInit {
