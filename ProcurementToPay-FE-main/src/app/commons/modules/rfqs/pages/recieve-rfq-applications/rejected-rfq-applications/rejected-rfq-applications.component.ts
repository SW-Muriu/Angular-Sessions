...
@Component({
  selector: 'app-rejected-rfq-applications',
  templateUrl: './rejected-rfq-applications.component.html',
  styleUrls: ['./rejected-rfq-applications.component.sass']
})
export class RejectedRfqApplicationsComponent extends BaseComponent implements OnInit {
  ...
  getTenders() {
    this.rfqApplicationsService
      .fetchAllVerifedRfqsWithRejectedApplications()
      .pipe(takeUntil(this.subject))
      .subscribe(
        (result) => {
          this.rfqApplications = result;

          console.log("RFQ Applications", this.rfqApplications)
  ...
  viewRfqApplications(id){
    console.log("View RFQ Navigation")
    this.router.navigate([`/commons/rfqs/rejected-rfq-applications/${id}`])
  }
