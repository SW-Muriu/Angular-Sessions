...
@Component({
  selector: 'app-approved-rfq-applications',
  templateUrl: './approved-rfq-applications.component.html',
  styleUrls: ['./approved-rfq-applications.component.sass']
})
export class ApprovedRfqApplicationsComponent extends BaseComponent implements OnInit {
  ...
  viewRfqApplications(id){
    this.router.navigate([`/commons/rfqs/approved-rfq-applications/${id}`])
  }
