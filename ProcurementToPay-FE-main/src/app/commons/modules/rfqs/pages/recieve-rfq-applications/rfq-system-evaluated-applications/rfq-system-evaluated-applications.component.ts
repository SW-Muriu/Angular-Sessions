...
@Component({
  selector: 'app-rfq-system-evaluated-applications',
  templateUrl: './rfq-system-evaluated-applications.component.html',
  styleUrls: ['./rfq-system-evaluated-applications.component.sass']
})
export class RfqSystemEvaluatedApplicationsComponent extends BaseComponent implements OnInit {
  ...
  getTenders(id) {
    this.rfqApplicationsService
      .fetchAllRfqApprovedApplicationsByRfqId(id)
  ...
  viewRfqApplications(id){
    this.router.navigate([`/commons/rfqs/pending-rfq-applications/${id}`])
  }
