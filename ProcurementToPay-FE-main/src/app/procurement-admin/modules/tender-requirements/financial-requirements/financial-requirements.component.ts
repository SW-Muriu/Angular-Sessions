...
@Component({
  ...
  styleUrls: ['./financial-requirements.component.sass']
})
export class FinancialRequirementsComponent implements OnInit {
  ...
  getRequirements() {
    this.tenderRequirementsService.getFinancialRequirements().subscribe(
      (res) => {
        console.log("Req: ", res);
