...
@Component({
  ...
  templateUrl: './approved-announcements.component.html',
  styleUrls: ['./approved-announcements.component.sass']
})
export class ApprovedAnnouncementsComponent implements OnInit {
