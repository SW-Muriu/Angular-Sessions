...
@Component({
  selector: 'app-posted-announcements',
  templateUrl: './posted-announcements.component.html',
  styleUrls: ['./posted-announcements.component.sass']
})
export class PostedAnnouncementsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getApprovedPostedAnnouncements();
  ...
  getApprovedPostedAnnouncements() {
