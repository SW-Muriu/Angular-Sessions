...
@Component({
  selector: 'app-pending-announcements',
  templateUrl: './pending-announcements.component.html',
  styleUrls: ['./pending-announcements.component.sass']
})
export class PendingAnnouncementsComponent implements OnInit {
  ...
  // i: number = 0;
  // names: any[] = ['str1', 'str2', 'str3', 'str4', 'str5'];
  // buttonValue: string = '';
  ...
  //     console.log(this.names[this.i]);
  //   }
  //   else if (this.i === this.names.length) {
