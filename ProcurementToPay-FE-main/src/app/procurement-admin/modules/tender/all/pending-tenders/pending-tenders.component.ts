...
@Component({
  selector: 'app-pending-tenders',
  templateUrl: './pending-tenders.component.html',
  styleUrls: ['./pending-tenders.component.sass']
})
export class PendingTendersComponent extends BaseComponent implements OnInit {
  ...
  deleteTender(tender){
    ...
    const dialogRef = this.dialog.open(DeleteTenderComponent, dialogConfig);
